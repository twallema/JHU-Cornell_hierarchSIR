...
class log_posterior_probability():
    ...
    def lognorm_logpdf(theta, season, idxs_per_season, s_idx, scale_idx):
        ...
        ) + expon.logpdf(theta[s_idx], scale=1/3))
    ...
    def build_prior_evaluation(self):
        ...
        # Hyperdistribution prior: |delta_beta_temporal_mu_i| ~ Exponential(1/3)
        ...
        # Hyperdistribution prior: thermal_delay_scale ~ Exponential(10)
        if 'thermal_delay_scale' in self.hyper_par_name_to_idx.keys():
            ...
            hyper_prior_lpp_fs.append((self.expon_hyper_logpdf, (thermal_delay_scale_idxs, 10)))        
